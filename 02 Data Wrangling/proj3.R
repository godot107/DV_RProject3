...
#this is very beautiful... could we try to average birthrates of regions? like in a group by to make it cleaner. group by REGION AND PRESENT AVERAGE BIRTHRATE?
